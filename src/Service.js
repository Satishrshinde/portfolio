          ...
          <div className="col__3">
            <div className="service__box pointer">
              ...
              <div className="service__meta ">
                ...
                <p className="service__text p__color">this is a paragraph to be written </p>
                <p className="service__text p__color">for the explanation of the </p>
                <p className="service__text p__color">web development</p>
              </div>
            </div>
          </div>
          <div className="col__3">
